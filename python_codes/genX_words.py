...
def genX(appIds_list,vocab_list,all_matrics):
        ...
        for file in all_matrics:
            ...
            if(appId_arr):
                ...
                if(appId in appIds_list):
                    appId_wordcnt[appId] = Counter(word_tokenize(f))
            else:
                print file
    ...
    out_X = open("word_feature.csv","w")
    out_X.write("AppIds,")
    out_X.write(",".join(vocab_list))
    out_X.write("\n")
    ...
    for appId in appIds_list:
        ...
        if appId not in appId_wordcnt:
            ...
            for word in vocab_list:
                out_X.write(str(app_counter[word]))
                out_X.write(",")
        out_X.write("\n")
...
if __name__ == "__main__":
    ...
    vocab_list = open("top2k_vocab_list.txt","r").read().split("\n")
